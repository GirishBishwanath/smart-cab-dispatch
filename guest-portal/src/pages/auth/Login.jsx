...
import { FaMapLocationDot, FaRoute, FaShieldHalved } from "react-icons/fa6";
...
const FEATURES = [
  ...
  { icon: FaRoute, title: "Rides", text: "Track your cab journey" },
          ...
          <div className="relative flex w-full flex-col px-10 py-9 xl:px-12 xl:py-10">
            ...
            <div className="my-auto max-w-[510px]">
              ...
              <p className="mt-5 max-w-[480px] text-[15px] leading-7 text-slate-400">
                Manage your ride requests, view your assigned cab and stay

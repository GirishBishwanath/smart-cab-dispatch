...
import { FaClock, FaMapLocationDot, FaRoute, FaArrowLeft } from "react-icons/fa6";
...
const Field = ({ id, name, label, type = "text", placeholder, value, onChange, error, disabled, className = "", autoComplete }) => (
    <div className={className}>
        ...
        <input
            ...
            className={`w-full rounded-lg border px-3 py-2 text-sm outline-none transition placeholder:text-slate-400 ${error ? "border-red-300 focus:ring-4 focus:ring-red-50" : "border-slate-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-50"
                    ...
                    <div className="relative flex w-full flex-col px-10 py-9 xl:px-12 xl:py-10">
                        <div className="flex items-center justify-between gap-3">
                            <a href={LANDING_URL} className="flex items-center gap-3">
                                <Logo invert />
                                <div>
                                    <p className="text-base font-bold text-white">Smart Cab</p>
                        ...
                        <div className="my-auto max-w-[500px]">
                            ...
                            <p className="mt-5 max-w-[480px] text-[15px] leading-7 text-slate-400">
                                Pin your pickup and drop-off on the map, then follow your
                                assigned cab in real time from request to arrival.
                            </p>
                        </div>
                ...
                <section className="flex min-h-0 flex-1 items-center justify-center overflow-y-auto bg-white px-5 py-6 sm:px-8 sm:py-7 lg:px-10 xl:px-12">
                    <div className="w-full max-w-[460px]">
                        ...
                        <div className="mb-4">
                            ...
                            <h2 className="mt-1.5 text-[30px] font-bold tracking-tight text-slate-950">Create your account</h2>
                            <p className="mt-1.5 text-sm leading-6 text-slate-500">Sign up to book and manage your rides.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} noValidate className="rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_8px_30px_rgba(15,23,42,0.06)] sm:p-6">
                            ...
                            <div className="grid gap-3">
                                ...
                                >
                                    ...
                                    {submitting ? "Creating account…" : "Create Guest Account"}
                                </button>
                            </div>
                        ...
                        <div className="mt-4 text-center text-sm text-slate-500">
                            ...
                            <button type="button" onClick={() => navigate(ROUTES.LOGIN)} className="cursor-pointer font-bold text-emerald-600 hover:text-emerald-700">
                                Sign in
                            </button>
                        </div>
                    </div>

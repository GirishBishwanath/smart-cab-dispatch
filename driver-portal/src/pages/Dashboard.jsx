...
const DriverStatusBadge = ({ status }) => (
    <span
        className={`inline-flex items-center gap-2 rounded-full px-2.5 py-1 text-[11px] font-bold ring-1 ring-inset ${DRIVER_STATUS_STYLES[status] ??
            DRIVER_STATUS_STYLES.OFFLINE
            }`}
    >

...
const createGuest = asyncHandler(async (req, res) => {
    ...
    return successResponse(res, guest, "Guest created successfully");
});
...
const getMyProfile = asyncHandler(async (req, res) => {
    ...
    return successResponse(res, profile, "Guest profile fetched successfully");
});

const updateMyProfile = asyncHandler(async (req, res) => {
    const profile = await guestService.updateMyProfile(req.user.id, req.body);
    return successResponse(res, profile, "Guest profile updated successfully");
});

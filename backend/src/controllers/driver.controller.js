...
const createDriver = asyncHandler(async (req, res) => {
    ...
    return successResponse(res, driver, "Driver created successfully");
});

const getMyProfile = asyncHandler(async (req, res) => {
    const profile = await driverService.getMyProfile(req.user.id);
    return successResponse(res, profile, "Driver profile fetched successfully");
});
...
const updateDriverStatus = asyncHandler(async (req, res) => {
    ...
    return successResponse(res, driver, "Driver status updated successfully");
});
